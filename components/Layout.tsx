  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center justify-between w-full relative max-w-4xl border-gray-200 dark:border-gray-700 mx-auto pt-8 pb-8 sm:pb-16  text-gray-900 bg-white  dark:bg-gray-900 dark:text-gray-100">
      ...
      <main
        id="skip"
        className="flex flex-col justify-center sm:px-8 px-5 bg-white dark:bg-gray-900"
      >
        {children}
        <Footer />
      </main>
